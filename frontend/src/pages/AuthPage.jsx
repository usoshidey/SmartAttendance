...
// "student-login"     → roll_no + password (gets direct token)
// "teacher-signup"    → name + email + password (sends verification email)
// "student-signup"    → name + roll_no + password (gets direct token)
// "email-verification" → message telling teacher to check email
  ...
  const handleCredentials = async () => {
    ...
    try {
      ...
      if (mode === "teacher-login") {
        ...
        login(res);  // Student gets direct token
          ...
          {mode === "email-verification" && (
            <>
              <FormHeader
                ...
                onBack={() => { setMode(isTeacher ? "teacher-login" : "role"); }}
              />
              ...
              <div style={{ marginBottom: 24, padding: 20, background: "rgba(16,185,129,0.08)", border: "1px solid rgba(16,185,129,0.25)", borderRadius: 12, textAlign: "center" }}>
                ...
                <div style={{ color: "#a5b4fc", fontSize: 12, lineHeight: 1.6, marginBottom: 12 }}>
                  {verificationMsg}
                </div>
              ...
              <div style={{ padding: "12px 14px", background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.15)", borderRadius: 8, color: "#6366f1", fontSize: 11, lineHeight: 1.6, marginBottom: 16 }}>
                💡 Check your spam/junk folder if you don't see the email. It may be marked as spam.
              </div>
